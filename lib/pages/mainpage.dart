                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(20),
                        gradient: const LinearGradient(
                          colors: [Color.fromARGB(255, 43, 192, 105), Color.fromARGB(255, 14, 153, 116)],
                          begin: Alignment.topLeft,
                          end: Alignment.bottomRight,
                        ),
                        boxShadow: [
                          BoxShadow(
                            color: const Color.fromARGB(255, 14, 153, 116).withOpacity(0.3),
                            blurRadius: 10,
                            offset: const Offset(0, 5),
                          ),
                        ],
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 4),
                                Text(
                                  'ค้นหาและขอเบิกสินค้าจากคลังสินค้า',
                                  style: TextStyle(
                          ...
                          Container(
                            ...
                            child: const Icon(
                              Icons.arrow_forward_ios_rounded,
                              color: Color.fromARGB(255, 14, 153, 116),
                              size: 14,
                            ),
                          ),
                        ],
