...
class CarData extends ChangeNotifier {
  ...
  final String url_to_addcar = "https://api.cicsupports.com/api/car/createcar";
  final String url_to_listcar_by_emp =
      "https://api.cicsupports.com/api/car/listcarbyemp";
  final String url_to_carphoto_by_id =
      "https://api.cicsupports.com/api/car/getcarphoto";
  final String url_to_car_close_photo_by_id =
      "https://api.cicsupports.com/api/car/getcarclosephoto";
  final String url_to_close_car =
      "https://api.cicsupports.com/api/car/closecar";
